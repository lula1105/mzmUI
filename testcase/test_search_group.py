...
try:
    ...
    testDataAndcheck = readY.read_oneYamlData(self, filePath)
    print(testDataAndcheck)
...
class TestSearchGroup:
    ...
    def test_serach_group(self, args):
        ...
        sg = serach_groupPage.searchGroup().opreateSearchGroupAndCheck(groupName, loginEmai, checkType, checkFindType, checkEle)
